...
namespace lwlog
{
	...
	template<template<typename, typename, typename> typename... Sinks>
	using basic_logger = logger<default_memory_buffer_limits, synchronous_policy, 
		immediate_flush_policy, single_threaded_policy, Sinks...>;

	template<template<typename, typename, typename> typename... Sinks>
	using basic_logger_mt = logger<default_memory_buffer_limits, synchronous_policy, 
		immediate_flush_policy, multi_threaded_policy, Sinks...>;

	template<template<typename, typename, typename> typename... Sinks>
	using async_logger = logger<default_memory_buffer_limits, asynchronous_policy<>, 
		immediate_flush_policy, single_threaded_policy, Sinks...>;

	template<template<typename, typename, typename> typename... Sinks>
	using async_logger_mt = logger<default_memory_buffer_limits, asynchronous_policy<>, 
		immediate_flush_policy, multi_threaded_policy, Sinks...>;
