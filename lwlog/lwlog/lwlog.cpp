...
namespace lwlog 
{
	...
	{
		registry::apply_to_all([pattern](logger_registry_interface* logger)
		{ 
	...
	{
		registry::apply_to_all([level_list](logger_registry_interface* logger)
		{
	...
	{
		registry::apply_to_all([buffer_size](logger_registry_interface* logger)
		{
	...
	{
		registry::apply_to_all([](logger_registry_interface* logger)
		{
	...
	{
		registry::apply_to_all([stamp](logger_registry_interface* logger)
		{
