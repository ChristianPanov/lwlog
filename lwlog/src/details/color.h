...
namespace lwlog::details::color
{
	...
	constexpr const char* foreground_br_black()		{ return "\u001b[30;1m"; }
	constexpr const char* foreground_br_red()		{ return "\u001b[31;1m"; }
	constexpr const char* foreground_br_green()		{ return "\u001b[32;1m"; }
	constexpr const char* foreground_br_yellow()	{ return "\u001b[33;1m"; }
	constexpr const char* foreground_br_blue()		{ return "\u001b[34;1m"; }
	constexpr const char* foreground_br_magenta()	{ return "\u001b[35;1m"; }
	constexpr const char* foreground_br_cyan()		{ return "\u001b[36;1m"; }
	constexpr const char* foreground_br_white()		{ return "\u001b[37;1m"; }
	...
	constexpr const char* background_br_black()		{ return "\u001b[40;1m"; }
	constexpr const char* background_br_red()		{ return "\u001b[41;1m"; }
	constexpr const char* background_br_green()		{ return "\u001b[42;1m"; }
	constexpr const char* background_br_yellow()	{ return "\u001b[43;1m"; }
	constexpr const char* background_br_blue()		{ return "\u001b[44;1m"; }
	constexpr const char* background_br_magenta()	{ return "\u001b[45;1m"; }
	constexpr const char* background_br_cyan()		{ return "\u001b[46;1m"; }
	constexpr const char* background_br_white()		{ return "\u001b[47;1m"; }
}