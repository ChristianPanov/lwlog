...
namespace lwlog::details
{
	...
	void alignment_formatter<BufferLimits>::format(memory_buffer<BufferLimits::pattern>& buffer, 
	...
	template<typename BufferLimits>
	void alignment_formatter<BufferLimits>::apply_padding(memory_buffer<BufferLimits::pattern>& buffer, std::size_t to_align_pos,
	...
	template<typename BufferLimits>
	void alignment_formatter<BufferLimits>::pad_left(memory_buffer<BufferLimits::pattern>& buffer, std::size_t to_align_pos,
		std::size_t to_align_size, std::uint8_t width, char fill_char)
	{
		const std::size_t padding_width{ width - to_align_size };

		char padding[BufferLimits::padding]{};
	...
	template<typename BufferLimits>
	void alignment_formatter<BufferLimits>::pad_right(memory_buffer<BufferLimits::pattern>& buffer, std::size_t to_align_pos,
		std::size_t to_align_size, std::uint8_t width, char fill_char)
	{
		const std::size_t padding_width{ width - to_align_size };
	...
	template<typename BufferLimits>
	void alignment_formatter<BufferLimits>::pad_center(memory_buffer<BufferLimits::pattern>& buffer, std::size_t to_align_pos,
		std::size_t to_align_size, std::uint8_t width, char fill_char)
	{
